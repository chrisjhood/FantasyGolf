...
class PicksControllerTest < ActionController::TestCase
  ...
  test "should create pick" do
    assert_difference('Pick.count') do
      post :create, pick: { earnings: @pick.earnings, golfer_id: @pick.golfer_id, tournament_id: @pick.tournament_id, user_id: @pick.user_id }
    end
  ...
  test "should update pick" do
    put :update, id: @pick, pick: { earnings: @pick.earnings, golfer_id: @pick.golfer_id, tournament_id: @pick.tournament_id, user_id: @pick.user_id }
    assert_redirected_to pick_path(assigns(:pick))
  end
